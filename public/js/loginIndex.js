...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionsLoginAction = __webpack_require__(4);

	var _actionsLoginAction2 = _interopRequireDefault(_actionsLoginAction);

	var _componentsFunctionsLoginComponent = __webpack_require__(6);
...
/***/ function(module, exports) {
	...
	exports['default'] = {
	   ...
	   *
	    * key,url中的键
	   */
	  getValueFromUrl: function getValueFromUrl(key) {
	    var matchKeys, result, str, urlRegExp;
	    result = null;
	    if (!key) {
	      urlRegExp = /#([\w]+)&?/;
	      str = location.hash;
